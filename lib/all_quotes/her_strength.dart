...
class HerStrength extends StatefulWidget {
  const HerStrength({super.key});
  @override
  State<HerStrength> createState() => _HerStrengthState();
}

class _HerStrengthState extends State<HerStrength> {
  // --- STATE VARIABLES ---

  // The master list of quotes for this category.
  List<String> herstrength = [
  ...
  Future<void> _loadAndFilterQuotes() async {
    ...
    if (mounted) {
      setState(() {
        ...
        herstrength.removeWhere((quote) => hiddenItems.contains(quote));
            ...
            children: [
              ...
              Expanded(
                child: CarouselSlider.builder(
                  itemCount: herstrength.length,
                  carouselController: _carouselSliderController,
                  itemBuilder: (context, index, realIndex) {
                    final item = herstrength[index];
                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(onPressed: () => Share.share("A powerful reminder: \"$item\""), icon: const Icon(Icons.share, color: Colors.black, size: 21)),
                                ],
                              ),
                            ),
                          ),
                  ...
                  options: CarouselOptions(
                    ...
                    enableInfiniteScroll: herstrength.length > 1,
                  ),
                ),
              ),
