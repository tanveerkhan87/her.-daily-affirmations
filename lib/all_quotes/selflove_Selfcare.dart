...
class SelfLoveSelfCare extends StatefulWidget {
  const SelfLoveSelfCare({super.key});
  @override
  State<SelfLoveSelfCare> createState() => _SelfLoveSelfCareState();
}

class _SelfLoveSelfCareState extends State<SelfLoveSelfCare> {
  // --- STATE VARIABLES ---

  // The master list of quotes for this category.
  List<String> selfloveandselfcare = [
  ...
  Future<void> _loadAndFilterQuotes() async {
    ...
    if (mounted) {
      setState(() {
        ...
        selfloveandselfcare.removeWhere((quote) => hiddenItems.contains(quote));
    ...
    return Scaffold(
      ...
      body: Consumer<StyleProvider>(
        builder: (context, styleProvider, child) {
          ...
          if (selfloveandselfcare.isEmpty) {
            ...
            children: [
              ...
              Expanded(
                child: CarouselSlider.builder(
                  itemCount: selfloveandselfcare.length,
                  carouselController: _carouselSliderController,
                  itemBuilder: (context, index, realIndex) {
                    final item = selfloveandselfcare[index];
                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      hideProvider.hideItemAndSave(item, () {
                                        ...
                                        setState(() {
                                          selfloveandselfcare.remove(item);
                                        });
                                      });
                                  ...
                                  IconButton(onPressed: () => Share.share("Affirmation for you: \"$item\""), icon: const Icon(Icons.share, color: Colors.black, size: 21)),
                                ],
                              ),
                            ),
                          ),
                  ...
                  options: CarouselOptions(
                    ...
                    enableInfiniteScroll: selfloveandselfcare.length > 1,
                  ),
                ),
              ),
