...
class ConfidenceAndEmpowerment extends StatefulWidget {
  const ConfidenceAndEmpowerment({super.key});
  @override
  State<ConfidenceAndEmpowerment> createState() => _ConfidenceAndEmpowermentState();
}

class _ConfidenceAndEmpowermentState extends State<ConfidenceAndEmpowerment> {
  // --- STATE VARIABLES ---

  // The master list of quotes for this category.
  List<String> confidenceandempowerment = [
  ...
  Future<void> _loadAndFilterQuotes() async {
    ...
    if (mounted) {
      setState(() {
        ...
        confidenceandempowerment.removeWhere((quote) => hiddenItems.contains(quote));
    ...
    return Scaffold(
      ...
      body: Consumer<StyleProvider>(
        builder: (context, styleProvider, child) {
          ...
          if (confidenceandempowerment.isEmpty) {
            ...
            children: [
              ...
              Expanded(
                child: CarouselSlider.builder(
                  itemCount: confidenceandempowerment.length,
                  carouselController: _carouselSliderController,
                  itemBuilder: (context, index, realIndex) {
                    final item = confidenceandempowerment[index];
                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      hideProvider.hideItemAndSave(item, () {
                                        ...
                                        setState(() {
                                          confidenceandempowerment.remove(item);
                                        });
                                      });
                                  ...
                                  IconButton(onPressed: () => Share.share("A dose of confidence: \"$item\""), icon: const Icon(Icons.share, color: Colors.black, size: 21)),
                                ],
                              ),
                            ),
                          ),
                  ...
                  options: CarouselOptions(
                    ...
                    enableInfiniteScroll: confidenceandempowerment.length > 1,
                  ),
                ),
              ),
