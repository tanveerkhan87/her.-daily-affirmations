...
class CareerAndLeadership extends StatefulWidget {
  const CareerAndLeadership({super.key});
  @override
  State<CareerAndLeadership> createState() => _CareerAndLeadershipState();
}

class _CareerAndLeadershipState extends State<CareerAndLeadership> {
  // --- STATE VARIABLES ---

  // The master list of quotes for this category.
  List<String> careerandleadership = [
  ...
  Future<void> _loadAndFilterQuotes() async {
    ...
    if (mounted) {
      setState(() {
        ...
        careerandleadership.removeWhere((quote) => hiddenItems.contains(quote));
    ...
    return Scaffold(
      ...
      body: Consumer<StyleProvider>(
        builder: (context, styleProvider, child) {
          ...
          if (careerandleadership.isEmpty) {
            ...
            children: [
              ...
              Expanded(
                child: CarouselSlider.builder(
                  itemCount: careerandleadership.length,
                  carouselController: _carouselSliderController,
                  itemBuilder: (context, index, realIndex) {
                    final item = careerandleadership[index];
                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      hideProvider.hideItemAndSave(item, () {
                                        ...
                                        setState(() {
                                          careerandleadership.remove(item);
                                        });
                                      });
                                  ...
                                  IconButton(onPressed: () => Share.share("Career advice for you: \"$item\""), icon: const Icon(Icons.share, color: Colors.black, size: 21)),
                                ],
                              ),
                            ),
                          ),
                  ...
                  options: CarouselOptions(
                    ...
                    enableInfiniteScroll: careerandleadership.length > 1,
                  ),
                ),
              ),
