...
class Inspirationcreativity extends StatefulWidget {
  const Inspirationcreativity({super.key});
  @override
  State<Inspirationcreativity> createState() => _InspirationcreativityState();
}

class _InspirationcreativityState extends State<Inspirationcreativity> {
  // --- STATE VARIABLES ---

  // The master list of quotes for this category.
  List<String> inspirationcreativity = [
  ...
  Future<void> _loadAndFilterQuotes() async {
    ...
    if (mounted) {
      setState(() {
        ...
        inspirationcreativity.removeWhere((quote) => hiddenItems.contains(quote));
    ...
    return Scaffold(
      ...
      body: Consumer<StyleProvider>(
        builder: (context, styleProvider, child) {
          ...
          if (inspirationcreativity.isEmpty) {
            ...
            children: [
              ...
              Expanded(
                child: CarouselSlider.builder(
                  itemCount: inspirationcreativity.length,
                  carouselController: _carouselSliderController,
                  itemBuilder: (context, index, realIndex) {
                    final item = inspirationcreativity[index];
                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      hideProvider.hideItemAndSave(item, () {
                                        ...
                                        setState(() {
                                          inspirationcreativity.remove(item);
                                        });
                                      });
                                  ...
                                  IconButton(onPressed: () => Share.share("A dose of inspiration: \"$item\""), icon: const Icon(Icons.share, color: Colors.black, size: 21)),
                                ],
                              ),
                            ),
                          ),
                  ...
                  options: CarouselOptions(
                    ...
                    enableInfiniteScroll: inspirationcreativity.length > 1,
                  ),
                ),
              ),
