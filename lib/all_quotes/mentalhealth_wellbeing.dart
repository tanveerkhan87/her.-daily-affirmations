...
class MentalHealthAndWellbeing extends StatefulWidget {
  const MentalHealthAndWellbeing({super.key});
  @override
  State<MentalHealthAndWellbeing> createState() => _MentalHealthAndWellbeingState();
}

class _MentalHealthAndWellbeingState extends State<MentalHealthAndWellbeing> {
  // --- STATE VARIABLES ---

  // The master list of quotes for this category.
  List<String> mentalHealthandwellbeing = [
  ...
  Future<void> _loadAndFilterQuotes() async {
    ...
    if (mounted) {
      setState(() {
        ...
        mentalHealthandwellbeing.removeWhere((quote) => hiddenItems.contains(quote));
    ...
    return Scaffold(
      ...
      body: Consumer<StyleProvider>(
        builder: (context, styleProvider, child) {
          ...
          if (mentalHealthandwellbeing.isEmpty) {
            ...
            children: [
              ...
              Expanded(
                child: CarouselSlider.builder(
                  itemCount: mentalHealthandwellbeing.length,
                  carouselController: _carouselSliderController,
                  itemBuilder: (context, index, realIndex) {
                    final item = mentalHealthandwellbeing[index];
                    return Container(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      hideProvider.hideItemAndSave(item, () {
                                        ...
                                        setState(() {
                                          mentalHealthandwellbeing.remove(item);
                                        });
                                      });
                                  ...
                                  IconButton(onPressed: () => Share.share("A helpful reminder: \"$item\""), icon: const Icon(Icons.share, color: Colors.black, size: 21)),
                                ],
                              ),
                            ),
                          ),
                  ...
                  options: CarouselOptions(
                    ...
                    enableInfiniteScroll: mentalHealthandwellbeing.length > 1,
                  ),
                ),
              ),
